...
mixin _$CapelasController on _CapelasBase, Store {
  late final _$valueAtom = Atom(name: '_CapelasBase.value', context: context);
  ...
  late final _$_CapelasBaseActionController =
      ActionController(name: '_CapelasBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_CapelasBaseActionController.startAction(
        name: '_CapelasBase.increment');
    try {
