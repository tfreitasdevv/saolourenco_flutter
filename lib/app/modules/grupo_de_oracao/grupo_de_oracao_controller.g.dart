...
mixin _$GrupoDeOracaoController on _GrupoDeOracaoBase, Store {
  late final _$valueAtom =
      Atom(name: '_GrupoDeOracaoBase.value', context: context);
  ...
  late final _$_GrupoDeOracaoBaseActionController =
      ActionController(name: '_GrupoDeOracaoBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_GrupoDeOracaoBaseActionController.startAction(
        name: '_GrupoDeOracaoBase.increment');
    try {
