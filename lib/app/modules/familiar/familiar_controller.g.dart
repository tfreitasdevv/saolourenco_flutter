...
mixin _$FamiliarController on _FamiliarBase, Store {
  late final _$valueAtom = Atom(name: '_FamiliarBase.value', context: context);
  ...
  late final _$_FamiliarBaseActionController =
      ActionController(name: '_FamiliarBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_FamiliarBaseActionController.startAction(
        name: '_FamiliarBase.increment');
    try {
