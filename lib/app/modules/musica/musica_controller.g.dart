...
mixin _$MusicaController on _MusicaBase, Store {
  late final _$valueAtom = Atom(name: '_MusicaBase.value', context: context);
  ...
  late final _$_MusicaBaseActionController =
      ActionController(name: '_MusicaBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_MusicaBaseActionController.startAction(
        name: '_MusicaBase.increment');
    try {
