...
mixin _$MembrosMusicaController on _MembrosMusicaBase, Store {
  late final _$valueAtom =
      Atom(name: '_MembrosMusicaBase.value', context: context);
  ...
  late final _$_MembrosMusicaBaseActionController =
      ActionController(name: '_MembrosMusicaBase', context: context);

  @override
  void increment() {
    final _$actionInfo = _$_MembrosMusicaBaseActionController.startAction(
        name: '_MembrosMusicaBase.increment');
    try {
